...
如果你是位会使用 3D Studio Max 和 After Effects 的架空放送大佬，那么伸手党 / 黑子十有八九会盯上你，并无条件要求（骚扰）你为他制作片头。这时你可以使用诱捕器进行反击。如果对方无条件要求你完全自制一个片头，又或者需要你按照他的要求制作，又或者是在某网站找到个 AE 模板要求你更改标版字给他，你尽量按照他的要求去做，做好后只需要把标版字改为 XXX（黑子名称）诱捕器即可。**请勿在无黑子要求制作电视包装时制作。**
