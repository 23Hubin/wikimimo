...
::: info
本段内容二次摘自 NewLifeWiki 的 [广播电视理论基础](https://newlifewiki.miraheze.org/wiki/广播电视理论基础) 条目，原内容来源于 DiamoWiki 的 [放送文化/基本概念分类](https://diamowiki.ga/wiki/分类:放送文化/基本概念)（dead link）的部分条目，内容均采用 CC BY-SA 4.0 转载，并由 WikiMimo 部分修订。
:::
